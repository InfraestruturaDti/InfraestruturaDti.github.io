            ...
            foreach ($Group in $Groups) {
                ...
                if ($Group.RecipientTypeDetails -eq "GroupMailbox") {
                    try {
                        ...
                        "ERROR: The specified object was not found, this should not happen..." | Out-File -FilePath "c:/logScript.txt" -Append}
                        ...
                        "ERROR: User object ""$($user.Name)"" not found, this should not happen..." | Out-File -FilePath "c:/logScript.txt" -Append}
                        ...
                        "ERROR: Group ""$($Group.DisplayName)"" uses dynamic membership, adjust the membership filter instead..." | Out-File -FilePath "c:/logScript.txt" -Append }
                        ...
                        "ERROR: User object ""$($user.Name)"" is Owner of the ""$($Group.DisplayName)"" group and cannot be removed..." | Out-File -FilePath "c:/logScript.txt" -Append}
                        ...
                        "ERROR: User object ""$($user.Name)"" is the only Owner of the ""$($Group.DisplayName)"" group and cannot be removed..." | Out-File -FilePath "c:/logScript.txt" -Append
                    }
            ...
            if ($IncludeAADSecurityGroups) {
                ...
                foreach ($groupAD in $GroupsAD) {
                    ...
                    #catch [Microsoft.Graph.PowerShell.Runtime.RestException`1] { #stupid module cannot even throw a proper error...
                        ...
                        "ERROR: You cannot remove members of the ""$($groupAD.AdditionalProperties.displayName)"" Dynamic group, adjust the membership filter instead..." | Out-File -FilePath "c:/logScript.txt" -Append}
                        ...
                        "ERROR: Group ""$($groupAD.AdditionalProperties.displayName)"" not found, this should not happen..." | Out-File -FilePath "c:/logScript.txt" -Append}
                        ...
                        "ERROR: User ""$($user.Name)"" not found, this should not happen..." | Out-File -FilePath "c:/logScript.txt" -Append}
                        ...
                        "ERROR: Either the userID or GroupID does not exist, or the user is not a member of the group. This should not happen..." | Out-File -FilePath "c:/logScript.txt" -Append}
                        else { $_ | fl * -Force; continue } #catch-all for any unhandled errors
                    }
                }
            }
